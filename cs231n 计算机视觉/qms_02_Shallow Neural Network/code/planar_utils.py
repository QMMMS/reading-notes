...
def load_extra_datasets():
    ...
    blobs = sklearn.datasets.make_blobs(n_samples=N, random_state=5, n_features=2, centers=2)
...
if __name__ == '__main__':
    ...
    # X：一个numpy的矩阵，维度为(2, 样本数)，包含了这些数据点的二维位置信息
    # Y：一个numpy的行向量，维度为(1, 样本数)，对应着的是X的标签【0 | 1】（红色:0 ， 蓝色 :1）
    ...
    clf.fit(X.T, Y.T.reshape(Y.shape[1], ))
    plt.subplot(1, 2, 2)
